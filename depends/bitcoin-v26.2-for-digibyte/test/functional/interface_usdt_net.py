...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/digibyte/digibyte/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our digibyted node")
