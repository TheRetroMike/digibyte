...
class TransactionTimeRescanTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine DGB and create transactions
        ...
        # send 10 dgb to user's first watch-only address
        self.log.info('Send 10 dgb to user')
        ...
        # send 5 dgb to our second watch-only address
        self.log.info('Send 5 dgb to user')
        ...
        # send 1 dgb to our third watch-only address
        self.log.info('Send 1 dgb to user')
