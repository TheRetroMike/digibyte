...
export CONTAINER_NAME=ci_native_nowallet_libdigibytekernel
...
export GOAL="install"
export DIGIBYTE_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
