...
QT_TRANSLATE_NOOP("digibyte-core", "Block verification was interrupted"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Error: Cannot extract destination from the generated scriptpubkey"),
QT_TRANSLATE_NOOP("digibyte-core", "Error: Could not add watchonly tx to watchonly wallet"),
QT_TRANSLATE_NOOP("digibyte-core", "Error: Could not delete watchonly transactions"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Error: Unable to begin reading all records in the database"),
QT_TRANSLATE_NOOP("digibyte-core", "Error: Unable to make a backup of your wallet"),
QT_TRANSLATE_NOOP("digibyte-core", "Error: Unable to parse version %u as a uint32_t"),
QT_TRANSLATE_NOOP("digibyte-core", "Error: Unable to read all records in the database"),
QT_TRANSLATE_NOOP("digibyte-core", "Error: Unable to remove watchonly address book data"),
...
QT_TRANSLATE_NOOP("digibyte-core", "No addresses available"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Transaction needs a change address, but we can't generate it."),
QT_TRANSLATE_NOOP("digibyte-core", "Transaction too large"),
QT_TRANSLATE_NOOP("digibyte-core", "Unable to allocate memory for -maxsigcachesize: '%s' MiB"),
...
QT_TRANSLATE_NOOP("digibyte-core", "Unable to find UTXO for external input"),
