...
{
    // Test regression https://github.com/digibyte/digibyte/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/digibyte-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/digibyte-core/gui/pull/568.
    // With fListen=false in ~/.config/DigiByte/DigiByte-Qt.conf and all else left as default,
    // digibyte-qt should set both -listen and -listenonion to false and start successfully.
