...
#ifndef DIGIBYTE_KERNEL_CONTEXT_H
#define DIGIBYTE_KERNEL_CONTEXT_H
...
//! passed to external libdigibyte_kernel functions which need access to this
...
#endif // DIGIBYTE_KERNEL_CONTEXT_H
