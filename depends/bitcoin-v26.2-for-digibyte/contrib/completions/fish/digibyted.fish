...
complete --command digibyted --no-files

# Extract options
function __fish_digibyted_get_options
...
complete \
    --command digibyted \
    --arguments "(__fish_digibyted_get_options --nofiles)"
