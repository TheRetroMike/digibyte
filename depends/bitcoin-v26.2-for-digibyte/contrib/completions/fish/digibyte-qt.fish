...
complete --command digibyte-qt --no-files

# Extract options
function __fish_digibyteqt_get_options
...
complete \
    --command digibyte-qt \
    --arguments "(__fish_digibyteqt_get_options --nofiles)"
