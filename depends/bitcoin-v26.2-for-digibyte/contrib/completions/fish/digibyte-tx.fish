...
# Extract options
function __fish_digibyte_tx_get_options
...
# Extract commands
function __fish_digibyte_tx_get_commands
...
complete \
    --command digibyte-tx \
    --condition "not __fish_digibyte_seen_cmd (__fish_digibyte_tx_get_commands --commandsonly)" \
    --arguments "(__fish_digibyte_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command digibyte-tx \
    --arguments "(__fish_digibyte_tx_get_commands)" \
    --no-files
