...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/digibyte-core/guix.sigs/tree/main/builder-keys
...
def verify_shasums_signature(
   ...
   ReturnCode, t.List[SigData], t.List[SigData], t.List[SigData], t.List[SigData]
    ...
    # which pubkeys within the DigiByte community do we trust for the purposes of
    # binary verification?
    trusted_keys = set()
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the digibyte release to download; of the format '
