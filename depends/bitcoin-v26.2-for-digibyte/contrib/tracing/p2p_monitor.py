...
""" Interactive digibyted P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for DigiByte Core can enable. It uses BCC
...
def main(digibyted_path):
    ...
    digibyted_with_usdts.enable_probe(
