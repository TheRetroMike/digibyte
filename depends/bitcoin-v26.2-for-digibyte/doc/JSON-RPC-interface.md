...
This is the endpoint used by digibyte-cli when a `-rpcwallet=` parameter is passed in.
...
digibyte-cli createwallet mywallet false false "" false false true

# "params": {"wallet_name": "mywallet", "load_on_startup": true}
digibyte-cli -named createwallet wallet_name=mywallet load_on_startup=true

# "params": {"args": ["mywallet"], "load_on_startup": true}
digibyte-cli -named createwallet mywallet load_on_startup=true
```
