...
application bridge enabled. The following routers are recommended for use with DigiByte Core:
...
Once an I2P router with SAM enabled is up and running, use the following DigiByte
...
debug log about your I2P configuration and connections. Run `digibyte-cli help
...
I2P support was added to DigiByte Core in version 22.0 and there may be fewer I2P
peers than Tor or IP ones. Therefore, using I2P alone without other networks may
make a node more susceptible to [Sybil
attacks](https://en.digibyte.it/wiki/Weaknesses#Sybil_attack). You can use
...
The first time DigiByte Core connects to the I2P router, it automatically
...
`i2p_private_key` in the DigiByte Core data directory.  The persistent I2P
...
## Fetching I2P-related information from DigiByte Core

There are several ways to see your I2P address in DigiByte Core if accepting
...
You can use the `getnodeaddresses` RPC to fetch a number of I2P peers known to your node; run `digibyte-cli help getnodeaddresses` for details.
...
It's important that the nodes of a popular application like DigiByte contribute
...
## Bundling I2P in a DigiByte application

Please see the "General Guidance for Developers" section in https://geti2p.net/en/docs/api/samv3
if you are developing a downstream application that may be bundling I2P with DigiByte.
