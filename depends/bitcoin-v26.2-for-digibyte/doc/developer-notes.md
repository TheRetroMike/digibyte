...
configuration options and toggled while digibyted is running with the `logging`
RPC.  For instance, launching digibyted with `-debug` or `-debug=1` will turn on
...
i.e. `CPPFLAGS="-DDEBUG_LOCKCONTENTION"`, then build and run digibyted.

You can then use the `-debug=lock` configuration option at digibyted startup or
`digibyte-cli logging '["lock"]'` at runtime to turn on lock contention logging.
It can be toggled off again with `digibyte-cli logging [] '["lock"]'`.
...
- [Init load (`b-initload`)](https://doxygen.digibytecore.org/namespacenode.html#ab4305679079866f0f420f7dbf278381d)
...
- [CCheckQueue::Loop (`b-scriptch.x`)](https://doxygen.digibytecore.org/class_c_check_queue.html#a6e7fa51d3a25e7cb65446d4b50e6a987)
...
- [TorControlThread (`b-torcontrol`)](https://doxygen.digibytecore.org/torcontrol_8cpp.html#a52a3efff23634500bb42c6474f306091)
...
- Net threads:
  ...
  - [ThreadI2PAcceptIncoming (`b-i2paccept`)](https://doxygen.digibytecore.org/class_c_connman.html#a57787b4f9ac847d24065fbb0dd6e70f8)
...
Some of these are maintained by active developers of DigiByte Core, in which case
...
a DigiByte Core subtree, so that they can be integrated quickly. Cosmetic changes
...
- src/leveldb
  - Subtree at https://github.com/digibyte-core/leveldb-subtree ; maintained by Core contributors.
...
- src/crc32c
  ...
  - Subtree at https://github.com/digibyte-core/crc32c-subtree ; maintained by Core contributors.
  - Upstream at https://github.com/google/crc32c ; maintained by Google.

- src/secp256k1
  - Upstream at https://github.com/digibyte-core/secp256k1/ ; maintained by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/digibyte-core/ctaes ; maintained by Core contributors.
