...
```
to: /path/to/digibyte/depends/x86_64-unknown-freebsd[release-number]
```
...
DigiByte Core can provide notifications via ZeroMQ. If the package is installed, support will be compiled in.
```bash
pkg install libzmq4
```
