...
"""Example logging DigiByte Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/digibyted
...
def main(digibyted_path):
    ...
    b = BPF(text=program, usdt_contexts=[digibyted_with_usdts])
