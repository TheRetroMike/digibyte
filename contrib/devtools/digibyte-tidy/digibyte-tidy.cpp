// Copyright (c) 2023 DigiByte Developers
...
public:
    ...
    {
        CheckFactories.registerCheck<digibyte::LogPrintfCheck>("digibyte-unterminated-logprintf");
    }
};

static clang::tidy::ClangTidyModuleRegistry::Add<BitcoinModule>
    X("digibyte-module", "Adds digibyte checks.");
