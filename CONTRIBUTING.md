...
[good first issue](https://github.com/DigiByte-Core/digibyte/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/DigiByte-Core/digibyte/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
The developer mailing list should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/digibyte/digibyte  # Fetch the latest upstream commit
...
spread out over GitHub, Gitter, Telegram, and mailing lists).
