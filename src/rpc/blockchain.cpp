...
// using node::BlockManager; // Removed due to conflict
...
static CBlockUndo GetUndoChecked(node::BlockManager& blockman, const CBlockIndex* pblockindex)
{
    CBlockUndo blockUndo;
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (chainman.m_blockman.IsPruneMode()) {
        ...
        const bool automatic_pruning{chainman.m_blockman.GetPruneTarget() != node::BlockManager::PRUNE_TARGET_MANUAL};
...
static bool CheckBlockFilterMatches(node::BlockManager& blockman, const CBlockIndex& blockindex, const GCSFilter::ElementSet& needles)
{
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (digibyte-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
        ...
        RPCExamples{
            HelpExampleCli("scanblocks", "start '[\"addr(dgbrt1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4d0wwte)\"]' 300000") +
            HelpExampleCli("scanblocks", "start '[\"addr(dgbrt1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4d0wwte)\"]' 100 150 basic") +
            HelpExampleCli("scanblocks", "status") +
            HelpExampleRpc("scanblocks", "\"start\", [\"addr(dgbrt1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4d0wwte)\"], 300000") +
            HelpExampleRpc("scanblocks", "\"start\", [\"addr(dgbrt1q4u4nsgk6ug0sqz7r3rj9tykjxrsl0yy4d0wwte)\"], 100, 150, \"basic\"") +
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable digibyted instance that is current with the network tip in a "
        ...
        "document (<https://github.com/digibyte/digibyte/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
