...
/** Default for -dandelion */
static const bool DEFAULT_DANDELION = true;

/** Dandelion discovery hash (fill with 0xff) */
...
/** The average additional embargo time beyond the minimum (seconds) */
...
public:
     ...
     * @see https://github.com/digibyte/digibyte/issues/21744 for details.
     */
    ...
    /** Whether this peer supports Dandelion++ protocol */
...
public:
    // Dandelion++ transaction inventory
    mutable Mutex cs_tx_inventory;
