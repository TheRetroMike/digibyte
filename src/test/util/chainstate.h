...
//
#ifndef DIGIBYTE_TEST_UTIL_CHAINSTATE_H
#define DIGIBYTE_TEST_UTIL_CHAINSTATE_H
    ...
    if (reset_chainstate) {
        {
            ...
            node.chainman->InitializeChainstate(node.mempool.get(), nullptr);
...
#endif // DIGIBYTE_TEST_UTIL_CHAINSTATE_H
