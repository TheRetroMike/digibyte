...
// Scrypt-specific endian functions to avoid conflicts with system headers
// These work with potentially unaligned pointers and are portable across all platforms
