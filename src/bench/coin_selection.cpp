...
static void addCoin(const CAmount& nValue, const wallet::CWallet& wallet, std::vector<std::unique_ptr<CWalletTx>>& wtxs)
{
...
static void CoinSelection(benchmark::Bench& bench)
{
    ...
    wallet::CWallet wallet(chain.get(), "", CreateMockableWalletDatabase());
