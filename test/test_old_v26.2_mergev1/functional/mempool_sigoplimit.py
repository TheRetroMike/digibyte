...
class BytesPerSigOpTest(DigiByteTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        # allow large datacarrier output to pad transactions, set low min relay fee for testing
        self.extra_args = [['-datacarriersize=100000', '-minrelaytxfee=0.00001', '-dandelion=0']]
    ...
    def test_sigops_package(self):
        ...
        self.restart_node(0, extra_args=["-bytespersigop=5000", "-minrelaytxfee=0.00001", "-dandelion=0", "-datacarriersize=100000"])
    ...
    def run_test(self):
        ...
        for bytes_per_sigop in (DEFAULT_BYTES_PER_SIGOP, 43, 81, 165, 327, 649, 1072):
            if bytes_per_sigop == DEFAULT_BYTES_PER_SIGOP:
                ...
                self.restart_node(0, extra_args=[bytespersigop_parameter, "-minrelaytxfee=0.00001", "-dandelion=0", "-datacarriersize=100000"])
