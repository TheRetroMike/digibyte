...
class SignMessagesWithPrivTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        priv_key = 'efsbBNHQmaJgE2N9FUG7a4fKBLKAGam4KAtVMZEPox4U6JQdnAhg'
        expected_signature = 'HzsjRNnAL6F6mPXXK9t3xPfPyDG8rsvfzejiTqZq6IYdJM1wWUcAhLLvaXGIJcI1dY5KKErRhSMxM8rxxx31PqE='
        ...
        assert_equal(addresses[0], 'sjPHVaqQykPcst8MXhvGz92i2onkvDU1Xj')
