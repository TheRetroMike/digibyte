...
random value payments which sum to 10DGB for each output type to Bob,
for a total of 40DGB in Bob's wallet.
...
class AddressInputTypeGrouping(DigiByteTestFramework):
