...
class WalletMultisigDescriptorPSBTTest(DigiByteTestFramework):
    ...
    def set_test_params(self):
        ...
        self.wallet_names = []
        self.extra_args = [["-keypool=100", "-dandelion=0", "-minrelaytxfee=0.00001"]] * self.num_nodes
    ...
    def run_test(self):
        ...
        psbt = participants["multisigs"][0].walletcreatefundedpsbt(inputs=[], outputs={to: value}, feeRate=0.001)
