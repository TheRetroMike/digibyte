...
class MempoolPackagesTest(DigiByteTestFramework):
    ...
    def chain_tx(self, utxos_to_spend, *, num_outputs=1):
        return self.wallet.send_self_transfer_multi(
            ...
            fee_per_output=20000)['new_utxos']  # DigiByte needs higher fees
    ...
    def run_test(self):
        ...
        replacable_tx = self.wallet.send_self_transfer_multi(from_node=self.nodes[0], utxos_to_spend=[chain[0]], fee_per_output=20000)['tx']
