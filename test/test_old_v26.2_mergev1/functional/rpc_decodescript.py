...
class DecodeScriptTest(DigiByteTestFramework):
    ...
    def decodescript_miniscript(self):
        ...
        # Sourced from https://github.com/digibyte/digibyte/pull/27037#issuecomment-1416151907.
        ...
        # DigiByte: Update expected address format
        desc = res["segwit"]["desc"]
        # Just check that it starts with addr(dgbrt1 instead of exact match
        assert desc.startswith("addr(dgbrt1"), f"Expected dgbrt1 address, got: {desc}"
