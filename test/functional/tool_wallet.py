...
class ToolWalletTest(DigiByteTestFramework):
    ...
    def digibyte_wallet_process(self, *args):
        ...
        return subprocess.Popen([self.options.digibytewallet] + default_args + list(args), stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
